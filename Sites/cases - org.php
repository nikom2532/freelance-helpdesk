...
if (document.service.title.value == "") {
				alert("กรุณาใส่  'หัวเรื่อง' ด้วยค่ะ");
...
<form action="cases2.php" method="post" enctype="multipart/form-data" name="service" id="service" onsubmit="return checkFields();">
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <td height="29" align="left"><fieldset style="width:700px"><legend><img src="images/title_case.png" width="150" height="47" /></legend>
          <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<!-- add -->
              ...
              <td>&nbsp;</td>
              <td align="right" class="Gray3">รหัสคอมพิวเตอร์ :</td>
              <td align="left">
			...
			<!-- add -->
            <tr>
              <td height="29" align="right" class="Gray3">หัวเรื่อง :</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td height="83" align="right" valign="top" class="Gray3">รายละเอียด :</td>
              <td>&nbsp;</td>
              <td colspan="2" align="left"><label>
            ...
            <tr>
              <td height="29" align="right" class="Gray3">อุปกรณ์ :</td>
              <td>&nbsp;</td>
              <td align="right" class="Gray3">&nbsp;</td>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td width="98" align="right"><label class="Gray3">ชื่ออุปกรณ์ :</label></td>
              <td width="392"  align="left">
				  <input type="text" name="name" id="name" value="" readonly="readonly" style="background-color:#CCCCCC" /><!-- 1 -->
                  <input type="hidden" name="wsitem_id" id="wsitem_id" value=""  /><!-- 2 -->
                <a href="selecthw.php" target="_blank"><img src="images/add.gif" width="24" height="24" border="0" title="เพิ่มอุปกรณ์" /></a><span class="red">*</span></td>
            </tr>
            <tr>
              <td height="30" align="right" valign="top" class="Gray3">&nbsp;</td>
              <td>&nbsp;</td>
              <td align="right" class="Gray3">รุ่น : </td>
              <td align="left">
            ...
            <tr>
              <td height="29" align="right" valign="top" class="Gray3">เอกสารแนบ :</td>
              <td>&nbsp;</td>
	...
	multi_selector.addElement( document.getElementById( 'my_file_element' ) );
                  ...
                  <span id="mySpan"></span> 
                <?php */ ?>
                <iframe src="queue_4formupload.php" style="border:0;">
					<form enctype="multipart/form-data" action="queue_4upload.php" method="POST">
            ...
            <tr>
              <td align="right" class="Gray3">ผู้แจ้ง :</td>
              <td>&nbsp;</td>
              <td colspan="2" align="left"><label>
              ...
              <a href="selectuser.php" target="_blank"><img src="images/add.gif" alt="" width="24" height="24" border="0" title="เพิ่มรายชื่อ" /></a></label></td>
            </tr>
            <tr>
              <td align="right" class="Gray3">แผนกผู้แจ้ง :</td>
              <td class="brown2">&nbsp;</td>
              <td colspan="2" align="left"><label>
            ...
            <tr>
              ...
              <td colspan="2" align="left">&nbsp;
               <input name="Submit" type="image" value="Submit" src="images/btn_submit2.png" />
                  <label><a href="user_main.php" onclick="return confirm('คุณต้องการยกเลิก ใช่หรือไม่ ?')" ><img src="images/btn_cancel2.png" width="82" height="30" border="0" /></a></label>
                 </td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
