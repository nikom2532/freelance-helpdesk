                    ...
                    <td width="870" align="center" valign="top"><form action="problemtype_edit2.php" method="post" name="problemtype" id="problemtype" onsubmit="return checkFields();">
                        <table width="505" border="0" cellspacing="0">
                          <tr>
                            ...
                            <td colspan="3" align="left" background="images/bar3_1.png" class="white"><img src="images/tools.png" width="24" height="24" align="absmiddle" />แก้ไขประเภทปัญหา :</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td align="right" valign="top" class="Gray3">รหัสประเภทปัญหา :</td>
                            <td class="Gray3">&nbsp;</td>
