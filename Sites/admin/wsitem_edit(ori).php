                  ...
                  <tr>
                    <td width="870" align="center" valign="top"><form action="wsitem_edit2.php" method="post" name="wsitem" id="wsitem">
                        <table width="505" border="0" cellspacing="0">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td align="right" valign="top" class="Gray3">รหัส :</td>
                            <td class="Gray3">&nbsp;</td>
                            <td align="left">
                         ...
                         <!--  <tr>
                          ...
                          <tr>
                            ...
                            <td align="left"><label>
                                ...
                                <label for="ws"></label>
                                <?
										$strSQL="SELECT DISTINCT c.com_detail, c.com_id  FROM computer c INNER JOIN ws_item ws ON ws.com_id = c.com_id ";
										 $result = mysql_query($strSQL);
									?>
                                <select name="ws" id="ws" >
									<? while($row = mysql_fetch_array($result)) {?>
											<option value=<?=$row['com_id'];?> <? if($com_id == $row['com_id'] ) { echo "selected='selected' "; }?> ><?php echo $row['com_detail'] ?> </option>
									<?} ?>
								</select>
                                </span>
                                </label></td>
                          ...
                          <tr>
                            ...
                            <td class="Gray3">&nbsp;</td>
                            <td align="left">
                             <?  if($fetchArray['isused']=='A'){ ?>
							        <input type="radio" name="isused" id="radio3" value="A"   class="Gray3" checked="checked"/>ยืม <br />
							<? }else{ ?>
                              <input type="radio" name="isused" id="radio" value="T"  <? if($fetchArray['isused']=='T'){ echo "checked='checked'";}?>  class="Gray3"/>
                              ใช้งาน <br />
                                <input type="radio" name="isused" id="radio2" value="B" <? if($fetchArray['isused']=='B'){ echo "checked='checked'";}?>  class="Gray3"/>
                                ส่งซ่อม<br />
                                <input type="radio" name="isused" id="radio4" value="C" <? if($fetchArray['isused']=='C'){ echo "checked='checked'";}?> class="Gray3" />
                                รอจำหน่าย <br />
                                <input type="radio" name="isused" id="radio5" value="F" <? if($fetchArray['isused']=='F'){ echo "checked='checked'";}?> class="Gray3" />
                                จำหน่ายแล้ว 
                               <? } ?>
                                </td>
                          </tr>
