...
<tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><table width="1000" border="0" align="center" cellspacing="0">
        ...
        <tr  class="center">
          <td colspan="2">
			...
			if($num_rows == '0' || $num_rows==''){
				  echo "<div class='red center'>ไม่มีเคสที่ต้องปิด  !! </div>" ;
			}else{
        ...
        <tr>
          <td colspan="2"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td width="102" height="39" align="center" background="images/bar3_1.png" class="white">ลำดับ</td>
              <td width="209" align="center" background="images/bar3_1.png" class="white">รหัสเรื่อง</td>
              <td width="230" align="center" background="images/bar3_1.png" class="white">หัวเรื่อง</td>
              <td width="170" align="center" background="images/bar3_1.png" class="white">วันที่เปิด</td>
              <td width="156" align="center" background="images/bar3_1.png" class="white">ลบ</td>
            </tr>
            <?
	//$i=1;
	$i=$pagelen*($page-1)+1;
    ...
    ?>
            <tr bgcolor="<? echo $bg ;?>">
              ...
              <td align="center" class="link"><a href="close_cases.php?id=<?=$fetchArray['case_ID']?>" title="ปิดงาน"  onclick="return confirm('คุณต้องการปิดรายการนี้ ใช่หรือไม่ ?')" class="vtip"><img src="images/btn_close.png" alt="" border="0" class="link_none"  /></a></td>
            </tr>
            <? 
	$i++ ;
	}
