...
if (document.problemtype.detail.value == "") {
				alert("กรุณาใส่  'ประเภทปัญหา' ด้วยครับ");
          ...
          <td align="center"><table width="501" border="1" cellspacing="0" bordercolor="#DDECFE">
            <tr>
              <td width="499"><table width="400" border="0" cellspacing="0">
                  <tr>
                    <td width="870" align="center" valign="top"><form action="problemtype_add2.php" method="post" name="problemtype" id="problemtype" onsubmit="return checkFields();">
                        <table width="505" border="0" cellspacing="0">
                          <tr>
                            <td height="34" background="images/bar3_1.png">&nbsp;</td>
                            <td colspan="3" align="left" background="images/bar3_1.png" class="white"><img src="images/add_page.png" width="32" height="32" align="absmiddle" /> เพิ่มประเภทปัญหา :</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td width="161" align="right" valign="top" class="Gray3">ประเภทปัญหา:</td>
