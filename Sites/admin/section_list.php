...
if($keyword!=""){
		$strSQL = "SELECT * FROM section WHERE section_detail LIKE '%$keyword%' ";
		$strSQL.="AND isused !='X' ";
}else{
		$strSQL = "SELECT * FROM section WHERE  isused !='X' ";
}
...
$strSQL .=" ORDER BY section_id  LIMIT $goto , $pagelen"; //echo $strSQL;
...
<tr>
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><table width="1000" border="0" align="center" cellspacing="0">
        ...
        <tr>
          ...
          <td width="179" align="left" class="green"><img src="images/add_page.png" width="32" height="32" align="bottom" /> <a href="section_add.php" ><span class="link_none">เพิ่มแผนก</span></a></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td colspan="2"><table width="900" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td width="63" height="39" align="center" background="images/bar3_1.png" class="white">ลำดับ</td>
              <td width="650" align="center" background="images/bar3_1.png" class="white">ชื่อแผนก</td>
    ...
    ?>
            <tr bgcolor="<? echo $bg ;?>">
              ...
              <td align="left"><?=$fetchArray['section_detail']?></td>
              <td align="center">
	<?
	  ...
	  ?></td>
              <td align="center"><a href="section_edit.php?id=<?=$fetchArray['section_id']?>" title="แก้ไข" class="vtip" ><img src="images/tools.png" width="24" height="24" border="0" /></a></td>
              <td align="center" class="link"><a href="section_del.php?id=<?=$fetchArray['section_id']?>" title="ลบ" class="vtip"  onclick="return confirm('คุณต้องการลบรายการนี้ ใช่หรือไม่ ?')"><img src="images/trash_can.png" width="24" height="24" class="link_none" border="0"  /></a></td>
              </tr>
      <? 
	$i++ ;
	}
