...
<tr>
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><table width="1000" border="0" align="center" cellspacing="0">
        ...
        <tr>
          ...
          <td width="180" align="left" class="green"><img src="images/add_page.png" width="32" height="32" align="bottom" /> <a href="news_add.php" ><span class="link_none">เพิ่มข่าวประกาศ</span></a></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td colspan="2"><table width="900" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              ...
              <td align="center" background="images/bar3_1.png" class="white">รายละเอียด</td>
	...
	<?
	  ...
	  ?></td>
              <td align="center"><a href="news_edit.php?id=<?=$fetchArray['news_id']?>" title="แก้ไข"  class='vtip' ><img src="images/tools.png" width="24" height="24" border="0" /></a></td>
              <td align="center" class="link"><a href="news_del.php?id=<?=$fetchArray['news_id']?>" title="ลบ"  onclick="return confirm('คุณต้องการลบรายการนี้ ใช่หรือไม่ ?')"  class='vtip'><img src="images/trash_can.png" width="24" height="24" class="link_none" border="0"  /></a></td>
              </tr>
      <? 
	$i++ ;
	}
