                    ...
                    <td width="870" align="center" valign="top"><form action="news_edit2.php" method="post" name="news" id="news" onsubmit="return checkFields();">
                        <table width="505" border="0" cellspacing="0">
                          <tr>
                            ...
                            <td colspan="3" align="left" background="images/bar3_1.png" class="white"><img src="images/tools.png" width="24" height="24" align="absmiddle" />แก้ไขข่าวประกาศ :</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td width="161" align="right" valign="top" class="Gray3">รหัส :</td>
