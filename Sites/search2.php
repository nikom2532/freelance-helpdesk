...
$cmdQuery =  mysql_query($strSQL);
            ...
            <tr>
              ...
              <td align="right">&nbsp;</td>
              <td align="left">
              <input type="submit" name="Search" id="Search" value="ค้นหา" style="width:100px" />
   </td>
              <td align="right">&nbsp;</td>
              <td colspan="2" align="right">&nbsp;</td>
            </tr>
    ...
    <tr>
      <td height="29">
			...
			if($num_rows == '0' || $num_rows==''){
				  echo "<div class='red center'>ไม่พบข้อมูลที่ท่านค้นหา  !! </div>" ;
			}else{
  ...
  <table width="1009" border="0" align="center" cellpadding="0" cellspacing="0"  class="margin-top">
   ...
   <table width="993" border="0" cellpadding="0" cellspacing="2" >
          ...
          <tr>
            ...
            <td width="103" background="images/bar5_1.png" class="white"><p align="center" class="white">รหัสเรื่อง</p></td>
            <td width="474" align="center" background="images/bar5_1.png" class="white">หัวเรื่อง</td>
       
            <td width="184" align="center" background="images/bar5_1.png" class="white">วันที่เปิด /  เวลา</td>
            <td width="122" align="center" background="images/bar5_1.png" class="white">สถานะ</td>
          </tr>
            <?
		$i=$pagelen*($page-1)+1;
