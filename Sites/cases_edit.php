...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <fieldset style="width:900px"><legend><img src="images/title_detail.png" width="150" height="47" /></legend><br />
            ...
            <tr>
              <td align="right">รหัสเรื่อง :</td>
              <td>&nbsp;</td>
              <td align="left"><?=$id;?></td>
              <td align="right">เจ้าของเรื่อง :</td>
              <td>&nbsp;</td>
              <td align="left"><?=$fetchArray['emp_name']; //ชื่อเจ้าของเรื่อง ?></td>
            </tr>
                <tr>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                   <td align="left"><?=$fetchArray['department']; //ชื่อแผนก?> </td>
              </tr>
                <tr>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td align="left">&nbsp;</td>
                  <td align="right">แจ้งเรื่องโดย :</td>
                  <td>&nbsp;</td>
                  <td align="left"><?=$fetchArray['create_by'];//ชื่อของคนเปิดเรื่อง  อาจไม่ใช่คนเดียวกับที่เปิดเรื่อง ?></td>
              </tr>
                <tr>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td align="left">&nbsp;</td>
                  <td align="right">รับเรื่องโดย :</td>
                  <td>&nbsp;</td>
                  <td align="left"><?=$fetchArray['work_by'];// ชื่อเจ้าหน้าที่ IT ที่รับเรื่องคนแรก ?></td>
              </tr>
                <tr>
                ...
                <tr>
                  <td rowspan="6" align="right" valign="top">รายละเอียด :</td>
                  ...
                  <td align="right" valign="top">IT ที่รับผิดชอบ : </td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td height="33" align="right" valign="top">เอกสารแนบ :</td>
                  <td>&nbsp;</td>
                  <td align="left"><?
	...
	multi_selector.addElement( document.getElementById( 'my_file_element' ) );
                ...
                <tr>
                  <td height="30" align="right">สถานะเรื่อง :</td>
                  <td>&nbsp;</td>
                  <td align="left">
                    <?
